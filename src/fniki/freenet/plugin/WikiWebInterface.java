...
public class WikiWebInterface extends Toadlet {
    ...
    private String handleWebRequest(HTTPRequest request, ToadletContext ctx, boolean createHtmlHeader)
        ...
        try {
	        ...
	        // SeekingForAttention: This could be insecure code because I have no clue and no documentation.
                ...
                if("Download of: jfniki.cfg".equals(forceDownload.getMessage())) {
                    ...
                    System.err.println("WikiWebInterface::handleWebRequest failed with a DownloadException: " +
                                       forceDownload.getMessage());
                    tmpResult = "Requested path " + request.getPath() + " can not be delivered: " +
                        forceDownload.getMessage() + "<br />Please report this message.<br />";

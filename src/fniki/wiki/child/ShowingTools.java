/* A UI subcomponent to display extra tools links.
 *
...
public class ShowingTools implements ChildContainer {
    private final static String TITLE = "jFniki Tools";
    public ChildContainerResult handle(WikiContext context) throws ChildContainerException {
        String html =
            context.fillInTemplate("show_tools.html",
                                   TITLE,
                                   context.makeLink("/"),
                                   context.getString("form_password",
                                                     "FORM_PASSWORD_NOT_SET"));
        return HtmlResultFactory.
            makeResult(TITLE, html, context.isCreatingOuterHtml());
    }
}
